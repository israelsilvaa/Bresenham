        ...
        for x in range(len(self.objMtraiz.matriz)):
                for y in range(len(self.objMtraiz.matriz)):
                    ...
                    for i in range(len(self.listaQ1)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ1[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ1[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ2)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ2[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ2[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ3)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ3[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ3[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ4)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ4[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ4[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ5)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ5[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ5[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ6)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ6[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ6[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ7)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ7[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ7[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"

                    for i in range(len(self.listaQ8)):
                        if self.objMtraiz.matriz[x][y][0] == self.listaQ8[i][0] and self.objMtraiz.matriz[x][y][1] == self.listaQ8[i][1]:
                            self.objMtraiz.matrizDePontos[x][y] = "  \033[31m X\033[m"
